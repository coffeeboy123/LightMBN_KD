...
from .attention import BatchDrop, BatchFeatureErase_Top, PAM_Module, CAM_Module, SE_Module, Dual_Module, BatchFeatureErase_Top_Bottom
...
class LMBN_n_bottom_no_test(nn.Module):
    def __init__(self, args):
        super(LMBN_n_bottom_no_test, self).__init__()
        ...
        self.batch_drop_block = BatchFeatureErase_Top_Bottom(512, OSBlock)
    ...
    def forward(self, x):
        ...
        if self.batch_drop_block is not None:
            glo_drop, glo_bottom, glo = self.batch_drop_block(glo)
        ...
        glo_bottom = self.channel_pooling(glo_bottom)
        ...
        f_glo_bottom = self.reduction_5(glo_bottom)
        ...
        return [f_glo_bottom[1], f_glo[1], f_glo_drop[1], f_p0[1], f_p1[1], f_p2[1], f_c0[1], f_c1[1]], fea, torch.stack([f_glo[0], f_glo_drop[0], f_p0[0], f_p1[0], f_p2[0], f_c0[0], f_c1[0]], dim=2)
