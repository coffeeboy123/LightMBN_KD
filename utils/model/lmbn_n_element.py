...
from .attention import BatchDrop, BatchFeatureErase_Top, PAM_Module, CAM_Module, SE_Module, Dual_Module, BatchFeatureErase_Top_Element
...
class LMBN_n_element(nn.Module):
    def __init__(self, args):
        super(LMBN_n_element, self).__init__()
        ...
        self.batch_drop_block = BatchFeatureErase_Top_Element(512, OSBlock)
    ...
    def forward(self, x):
        ...
        if self.batch_drop_block is not None:
            glo_drop, glo, glo_element = self.batch_drop_block(glo)
        ...
        glo_element = self.channel_pooling(glo_element)
        ...
        f_glo_element = self.reduction_5(glo_element)
        ...
        return [f_glo_element[1], f_glo[1], f_glo_drop[1], f_p0[1], f_p1[1], f_p2[1], f_c0[1], f_c1[1]], fea, torch.stack([f_glo_element[0], f_glo[0], f_glo_drop[0], f_p0[0], f_p1[0], f_p2[0], f_c0[0], f_c1[0]], dim=2)
