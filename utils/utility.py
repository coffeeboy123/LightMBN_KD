...
class checkpoint():
    def __init__(self, args):
        ...
        self.dir = os.path.join('/content/gdrive/MyDrive/SAVE_VAL_KD_QAT_ERORR_NO_HIDDEN', exp_folder)
        _make_dir(self.dir)
    ...
    def plot_losses(self, train_total, val_total, train_ce, val_ce, train_ms, val_ms, train_kl, val_kl):
        """
        총 3개 plot을 저장
