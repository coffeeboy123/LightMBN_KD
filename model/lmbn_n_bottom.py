...
class LMBN_n_bottom(nn.Module):
    def __init__(self, args):
        super(LMBN_n_bottom, self).__init__()
    ...
    def forward(self, x):
        ...
        return [f_glo_bottom[1], f_glo[1], f_glo_drop[1], f_p0[1], f_p1[1], f_p2[1], f_c0[1], f_c1[1]], fea, torch.stack([f_glo_bottom[0], f_glo[0], f_glo_drop[0], f_p0[0], f_p1[0], f_p2[0], f_c0[0], f_c1[0]], dim=2)
