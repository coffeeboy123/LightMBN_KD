...
class LMBN_n_osnet_x0_25_student_full(nn.Module):
    def __init__(self, args):
        ...
        self.batch_drop_block = BatchFeatureErase_Top_Bottom_Element_student(args.feats_student, OSBlock)
    ...
    def forward(self, x):
        ...
        return [f_glo_element[1], f_glo_bottom[1], f_glo[1], f_glo_drop[1], f_p0[1], f_p1[1], f_p2[1], f_p3[1], f_c0[1], f_c1[1]], fea, torch.stack(
            [f_glo[0], f_glo_drop[0], f_p0[0], f_p1[0], f_p2[0], f_p3[0], f_c0[0], f_c1[0]], dim=2), torch.stack(
            [f_glo[1], f_p0[1], f_p1[1], f_p2[1], f_p3[1], f_c0[1], f_c1[1]], dim=1)
